...
public class ProductControllerTest {
	...
	public void testGetProductById() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(productDto)) ? "false"
						: "true"),
				businessTestFile);
	...
	public void testGetAllProductsBySeller() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(productDtos)) ? "false"
						: "true"),
				businessTestFile);
