...
public class CustomerControllerTest {
	...
	public void testGetAllCustomers() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(customerDtos)) ? "false"
						: "true"),
				businessTestFile);
	...
	public void testGetCustomerById() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(customerDto)) ? "false"
						: "true"),
				businessTestFile);
	...
	public void testDeleteCustomer() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(true)) ? "false"
						: "true"),
				businessTestFile);
	...
	public void testGetAllBidsOnProductAfterEndDate() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(bidsDtos)) ? "false"
						: "true"),
				businessTestFile);
