...
public class SellerControllerTest {
	...
	public void testGetAllSellers() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(sellerDtos)) ? "false"
						: "true"),
				businessTestFile);
	...
	public void testGetSellerById() throws Exception {
		...
		MvcResult result = mockMvc.perform(requestBuilder).andReturn();
		yakshaAssert(currentTest(),
				(result.getResponse().getContentAsString().contentEquals(MasterData.asJsonString(sellerDto)) ? "false"
						: "true"),
				businessTestFile);
